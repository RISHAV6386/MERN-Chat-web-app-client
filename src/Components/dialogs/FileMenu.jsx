...
const FileMenu = ({ anchorEl,chatId}) => {
    ...
    const fileChangeHandler = async(e, key) => {
        ...
        if (files.length > 5) return toast.error(`You can send only 5 ${key} at a time.`)
    ...
    return (
        <Menu anchorEl={anchorEl} open={isFileMenu} onClose={closeFileMenu} >
            <div style={{ width: "10rem" }}>
                <MenuList>
                    <MenuItem onClick={() => selectItem(imageRef)}>
                        <Tooltip title="Image">
                            <ImageIcon />
                        </Tooltip>
                    ...
                    <MenuItem onClick={() => selectItem(audioRef)}>
                        <Tooltip title="Audio">
                            <AudioFileIcon />
                        </Tooltip>
                    ...
                    <MenuItem onClick={() => selectItem(videoRef)}>
                        <Tooltip title="Video">
                            <VideoFileIcon />
                        </Tooltip>
                    ...
                    <MenuItem onClick={() => selectItem(fileRef)}>
                        <Tooltip title="File">
                            <UploadFileIcon />
                        </Tooltip>
